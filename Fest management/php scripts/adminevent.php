...
<div class='container'><form action='eventupdate.php' method='POST'>
			<div id='update'>
			<h1>Update Events</h1>
			<div> <input class='textbox' type='text' name='eventname' placeholder='Event name' required='required'></div>

			<div> <input class='textbox' type='text' placeholder='Time' name='time'; ></div>
			<div> <input class='textbox' type='text' placeholder='Venue' name='venue'; ></div>

			
			
			<div><input type='submit'; name='submit'; value='UPDATE'></div></div></form></div><br><br>
<p style="font-size: 20px;color: white"> Update one at a time !!! </p><br>
</form> 
</center> 
</body> 
</html>